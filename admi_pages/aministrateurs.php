                ...
                <div>
                 ...
                 <div>
                  ...
                  <div>
                    ...
                    <div class="col-sm-10">
                     <input id="telephone" maxlength="12" minlength="1" name='telephone' type="number" class="form-control" placeholder="Numero de telephone" autocomplete="off" required="" /><br>
                    </div> 
                  </div>
                  <div>
