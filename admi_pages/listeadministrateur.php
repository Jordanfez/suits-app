...
<section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="index.html" class="logo"><b>ADMI<span>NISTRATEUR</span></b></a>
      <!--logo end-->
    </header>
    <!--header end-->
    <!-- **********************************************************************************************************************************************************
 ...
 <!-- section/ afficharge du modal pour modification -->
    <?php
        ...
        $requete = " SELECT * FROM administrateurs WHERE etat ='on' " ;
                ...
                <td>
                    ...
                    <button onclick="document.getElementById('prend<?php echo $i ?>').style.display='block'" name="sup" type="submit" class="btn-xm btn-danger" title="supprimer"><i class="fa fa-trash"></i></button>
                      ...
                      <div style="background-color: rgb(69, 201, 211);">
                        ...
                        <div class="container">
                            <form action='deled.php' method='POST'  style="text-align: center; width: 45%;">
                              <input type='text' class='d-none' name='topi' value="<?php echo $resultat['id'] ?>">
                              <div class="modal-body col-sm-10">
                                  <h4 style=" width: 123%;"> Voulez-vous supprimer cette intervention ?</h4>
                              </div>
                              <div class="modal-footer" style="float: right;">
                                <button class="btn btn-success"  name='supprime' type="submit" >OUI</button>
                        ...
                        <div class="container " >
                          ...
                          <form  class="topi" method="POST" action="deled.php">
                            <div class="modal-body col-sm-10">
                                ...
                                <div class="col-sm-10">
                                <input id="nom" type="text" class="form-control"  value="<?php echo $resultat['nom']?>" name="nom" required><br>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                <input id="client" type="text" class="form-control" value="<?php echo $resultat['adresse']?>" name="fax" required ><br>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="modal-footer" style="float: right">
                              <button onclick="getconfirm()" type="submit" name="update" class="btn btn-primary">Valider</button>
