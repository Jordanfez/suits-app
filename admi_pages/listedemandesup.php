...
<section id="container">
  ...
  <section id="main-content">
        ...
        <div class="row mt">
          ...
          <div class="col-lg-12">
            <div class="form-panel">
              ...
              <p> <strong> LISTE DES DEMANDES D'INTERVENTION SUPPRIMEES</strong></p>
    ...
    <?php
        ...
        $requete = " SELECT * FROM demande WHERE etat ='off' " ;
           ...
           $i = 1 ;
            while($resultat = mysql_fetch_assoc($sql)){
              ?>
                ...
                <td><form action='deldema.php' method='POST'><input type='text' class='d-none' name='A' value="<?php echo $resultat['id'] ?>"><input type='submit' class='btn btn-primary' name='rest' value='restorer'></form></td>
                </tr>
                <?php
                $i++ ;
           }
