            ...
            while($resultat = mysql_fetch_assoc($sql)){
              ?>
                <tr>
                  ...
                  <button onclick="document.getElementById('prend<?php echo $i ?>').style.display='block'" name="resto" type="submit" class="btn-xm btn-primary" title="restaurer"><i class="fa fa-upload"></i></button>
