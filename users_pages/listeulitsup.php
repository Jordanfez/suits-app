            ...
            while($resultat = mysql_fetch_assoc($sql)){
              ?>
                ...
                <td>
                     ...
                     <button onclick="document.getElementById('prend<?php echo $i ?>').style.display='block'" name="rer" type="submit" class="btn-xm btn-primary" title="restaurer"><i class="fa fa-upload"></i></button>
                      ...
                      <div style="background-color: rgb(69, 201, 211);">
                        ...
                        <div class="container">
                            <form action='delutil.php' method='POST'  style="text-align: center; width: 45%;">
                              <input type='text' class='d-none' name='pui' value="<?php echo $resultat['id'] ?>">
                              <div class="modal-footer" style="float: right;">
                                <button class="btn btn-success"  name='rer' type="submit" >OUI</button>
