...
<section id="container">
        ...
        <div class="row mt">
          ...
          <div class="col-lg-12">
            <div class="form-panel">
              ...
              <p><a href="listeclient.php" title="Page precedente">retour</a></p>
              <h3  style =" text-align : center;"> <u> RESULTAT DE LA CHERCHER </u></h3><br>
 ...
 <?php
     ...
     include 'function_recher_client.php';
