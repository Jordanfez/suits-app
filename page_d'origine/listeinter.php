<?php
   session_start();
   if (isset($_POST['save'])){
    if(!empty($_POST['nom']) AND !empty($_POST['nom1']) ){
      $nom = htmlspecialchars($_POST['nom']);
      $nom2= htmlspecialchars($_POST['nom1']);
      $con1 = mysql_connect("localhost", "root", "") or die(mysql_error()) ;
      $db = mysql_select_db("lsdi") or die(mysql_error()) ;
      $requete1 = "INSERT INTO effectuer( nom_technicien ,nom_intervention, etat) VALUES('$nom', '$nom2','on') " ;
                    ...
                    <div class="modal" id="msg<?php echo $i ?>" style="overflow: scroll; margin-left: 14%">
                      ...
                      <div style="background-color: rgb(69, 201, 211);">
                          ...
                          <form class="popo" method="POST" action="delinter.php">
                                ...
                                <div class="col-sm-10">
                                  <input type="text" maxlength="75" minlength="1" class="form-control" value="<?php echo $resultat['nom']?>"  name="nom" required><br>
                                </div>
                                <div class="form-group">
                  ...
                  <div class="x_content">
                    ...
                    <div class="tab-content" id="myTabContent">
                      ...
                      <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                        Pour pouvoir voir les information que vous desirez affichees vous devez au prealable selectionnez le nom de l'intervention
                        puis vous cliquez sur voir et en suite vous rentrez a nouveau sur la page info et vos information serons afficher   
