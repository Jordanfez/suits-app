...
<header class="header blue-bg"style="right: -3%; margin-left: -1.5%;">
   <div class="contact" style="background-color:#4ecdc4; "><br>
        ...
        <div class="maket">
          <img style="position: relative; color: black; right: -1%; margin-top: -3%;" src="img/suit.png" alt="">
       </div>
    </div>
    </header>
  </section>
                              ...
                              <div class="text-xs font-weight-bold text-info text-uppercase mb-1"style="margin-left:4%;font-size: 13px;">
                               ...
                               ?>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800" style="margin-left:4%;font-size: 17px;">
                                     <div class="col-sm-2 col-sm-2 control-label"><?php echo $resul["COUNT(*)"]-1; ?></div> 
                                     <div class="col-sm-10" style="margin-left: -9%; ">client(s)</div>
                                    </div>
                            </div>
                      </div>
                  </div>
                      ...
                      <div class="row no-gutters align-items-center">
                          <div class="col mr-2">
                              <div class="text-xs font-weight-bold text-info text-uppercase mb-1" style="margin-left:4%;font-size: 13px;">
                               ...
                               ?>
                              <div class="h5 mb-0 font-weight-bold text-gray-800" style="margin-left:4%;font-size: 17px;">
                              <div class="col-sm-2 col-sm-2 control-label"><?php echo $resul2["COUNT(*)"]-1; ?></div> 
                              <div class="col-sm-10" style="margin-left: -9%; ">Intervention(s)</div>
                              </div>
                          </div>
                          <div class="col-auto">
                      ...
                      <div class="row no-gutters align-items-center">
                          <div class="col mr-2">
                              ...
                              <?php
                               ...
                               ?>
                              <div class="h5 mb-0 font-weight-bold text-gray-800" style="margin-left:4%;font-size: 17px;">
                              <div class="col-sm-2 col-sm-2 control-label"><?php echo $resul3["COUNT(*)"]-1; ?></div> 
                              <div class="col-sm-10" style="margin-left: -9%; ">technicien(s)</div>
                             </div>
                          </div>
                          <div class="col-auto">
                          </div>
                      ...
                      <div class="row no-gutters align-items-center">
                          <div class="col mr-2">
                              <div class="text-xs font-weight-bold text-info text-uppercase mb-1" style="margin-left:4%;font-size: 13px;">
                               ...
                               ?>
                              <div class="h5 mb-0 font-weight-bold text-gray-800" style="margin-left:4%;font-size: 17px;">
                              <div class="col-sm-2 col-sm-2 control-label"><?php echo $resul4["COUNT(*)"]-1; ?></div> 
                              <div class="col-sm-10" style="margin-left: -9%; ">utisateur(s)</div>
                              </div>
                          </div>
                          <div class="col-auto">
                          </div>
