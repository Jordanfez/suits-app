           ...
           $i = 1 ;
            while($resultat = mysql_fetch_assoc($sql)){
              ?>
                ...
                <td><form action='delinter.php' method='POST'><input type='text' class='d-none' name='po' value="<?php echo $resultat['id'] ?>"><input type='submit' class='btn btn-primary' name='supro' value='restorer'></form></td>
                </tr>
                <?php
                $i++ ;
            }
