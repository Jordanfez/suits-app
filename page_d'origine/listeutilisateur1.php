    ...
    session_start();
      if (isset($_POST['envoi'])){
        if(!empty($_POST['numero_utilisateur']) || !empty($_POST['nom']) || !empty($_POST['prenom']) || !empty($_POST['adresse']) || !empty($_POST['roles']) || !empty($_POST['pwd']) ){
          ...
          header("location: listeutilisateur1.php ") ;
        }else{
            ...
            <div class="modal-content">
              ...
              <div>
               ...
               <div> 
                    ...
                    <div class="col-sm-10">
                    <input type="text" maxlength="30" minlength="1" id="pwd" name="pwd" placeholder="Mot de passe de l'utilisateurs" autocomplete="off" class="form-control placeholder-no-fix"required="" /><br>
                    </div>
              </div>
              </div>
