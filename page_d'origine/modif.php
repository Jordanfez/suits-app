          ...
          <div class="col-sm-12">
            ...
            <form class="toto" method="POST" action="del.php">
              <div class="form-group">
                  ...
                  <div class="col-sm-10">
                  <input type="text" class="form-control" value="<?php echo $resultat['fax']?>" name="fax" required >
                  </div>
                  <div class="form-group">
                ...
                <button name="update"  type="submit" class="btn btn-primary" >Valider</button>
                <button name="update"  type="submit" class='btn btn-success' href="listeclient.php"> retour</button>
            </form>
            </section>
          </div>
        </div>
