<?php
      ...
      //** */
      $sql = " SELECT * FROM administrateurs WHERE pwd = '$identif' ";
      $requete = mysql_query( $sql, $con) or die("toto");
      ...
      if (isset($_FILES["profit"]["name"])) {
        ...
        if ($resultat = move_uploaded_file($_FILES["profit"]["tmp_name"], $destination)) {
          global $con;
          $sql = " UPDATE administrateurs SET images = '$image' WHERE pwd = '$identif' ";
          $requete = mysql_query($sql, $con ) or die('toto');
          if ($requete) {
          ...
          */ }
          ...
          $sql = " SELECT * FROM administrateurs WHERE pwd = '$identif' AND images = '$image' ";
    ...
    /*  $bdd = new PDO("mysql:host=127.0.0.1;dbname=lsdi;", "root", "");
...
<section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="index.html" class="logo"><b>PROFIL<span>-ADMIN</span></b></a>
      <!--logo end-->
            ...
            <div class="card-header">
              ...
              <?php
                if (isset($_SESSION['pwd'])) {
                  ...
                  $con = mysql_connect("localhost", "root", "") or die(mysql_error()) ;
                  $db = mysql_select_db("lsdi") or die(mysql_error()) ;
                  $requete = " SELECT * FROM administrateurs WHERE etat='on' AND pwd = '$login' ";
              ...
              <div class="card-body row">
                ...
                <div>
                  <form  method="post" enctype="multipart/form-data">
                    <img src="<?php echo $src ?>" class="img-circle elevation-2" alt="profil" width="100%" height="200px">
