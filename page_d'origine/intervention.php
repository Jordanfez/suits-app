...
<section id="container">
  ...
  <section id="main-content">
        ...
        <h3><i class="fa fa-angle-right"></i> enregistrement d'une intervention</h3>
          ...
          <div class="">
              <label class="col-sm-2 col-sm-2 control-label" style=" color: black; opacity: 77%;">nom de l'intervention</label>
              <div class="col-sm-10">
        ...
        <div class="">
            <label class="col-sm-2 col-sm-2 control-label" style=" color: black; opacity: 77%;">nom du client</label>
            <div class="col-sm-10">
