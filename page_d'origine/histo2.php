    ...
    <section id="main-content">
      ...
      <h2><i class="fa fa-angle-right"></i> Sélectionné votre chemin</h2><br>  
          <div class="col-lg-12">
            ...
            <a href="listehistorique.php"class="btn btn-primary btn-lg" style="color: white;">HISTORIQUE DES  INTERVENTIONS <br> EFFECTUées</a>
            <a href="histoenregistrement.php"class="btn btn-success btn-lg" style="color:  white;">HISTORIQUE DES  ENREGISTREMENTS <br>(OPERATIONS) EFFECTUés</a>
            <a href="liste_des_suppression.php"class="btn btn-danger btn-lg" style="color: white;" >LISTE DES  SUPPRESSIONS <br> EFFECTUées</a>
           </div>
          </div>
        </div>
      </section>
