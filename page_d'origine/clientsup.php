  ...
  <section id="main-content">
      <section class="wrapper">
        <div class="row mt">
          ...
          <div class="col-lg-12">
            <div class="form-panel">
              ...
              <p> <strong> LISTE DES CLIENTS DE L'ENTREPRISE SUPPRIMER </strong></p>
        <tr style=" padding-right: 20px; " class="w3-blue">
            ...
            <td>fax client</td>
            <td>E-mail</td>
            <td colspan='1' style='text-align: center'>Options</td>
        </tr>
     </div>
    </div>
   </div>
            ...
            while($resultat = mysql_fetch_assoc($sql)){
              ?>
               <tr>
                ...
                <td><form action='del.php' method='POST'><input type='text' class='d-none' name='ta' value="<?php echo $resultat['id'] ?>"><input type='submit' class='btn btn-primary' name='res' value='restorer'></form></td>
                </tr>
                <?php
                $i++ ;
            }
