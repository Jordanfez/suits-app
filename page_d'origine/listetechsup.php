        ...
        <div class="row mt">
          ...
          <div class="col-lg-12">
            <div class="form-panel">
              ...
              <p> <strong> LISTE DES TECHNICIENS SUPPRIMES </strong></p>
            ...
            while($resultat = mysql_fetch_assoc($sql)){
              ?>
                <tr>
                  ...
                  <td><form action='deltech.php' method='POST'><input type='text' class='d-none' name='to' value="<?php echo $resultat['id'] ?>"><input type='submit' class='btn btn-primary' name='resto' value='restorer'></form></td>
                </tr>
                <?php
                $i++ ;
            }
